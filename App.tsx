...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050101] text-white selection:bg-[#a6ff00] selection:text-black">
      ...
      <Section className="relative overflow-hidden pt-12 text-center" style={{ background: 'linear-gradient(to bottom, #290505, #221126)' }}>
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="relative w-full max-w-3xl mb-12 animate-float-slow">
            <img src="https://i.imgur.com/Vu3cjJF.png" alt="Mockup Pack Flora Line" className="w-full h-auto drop-shadow-[0_30px_60px_rgba(0,0,0,0.9)]" />
          </div>
      ...
      <Section id="ofertas" style={{ background: 'linear-gradient(135deg, #0F0302 0%, #1A0404 100%)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
          ...
          >
            ...
            <img src="https://i.imgur.com/HWI5ujg.png" alt="Professional Pack" className="w-full max-w-[650px] h-auto mb-14 drop-shadow-[0_25px_50px_rgba(0,0,0,0.7)] scale-125" />
