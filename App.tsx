...
const customSlides = [
  "images/bloco7-1.webp",
  "images/bloco7-2.webp",
  "images/bloco7-3.webp",
];
...
const comparisonSlides = [
  "images/bloco5-1.webp",
  "images/bloco5-2.webp",
  "images/bloco5-3.webp",
];
    ...
    <div className="min-h-screen bg-[#050101] text-white selection:bg-[#a6ff00] selection:text-black">
      ...
      <Section className="relative overflow-hidden pt-12 text-center" style={{ background: 'linear-gradient(to bottom, #2A0505, #1C0202)' }}>
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="relative w-full max-w-3xl mb-12 animate-float-slow">
            <img src="images/bloco1.webp" alt="Mockup Pack Flora Line" className="w-full h-auto drop-shadow-[0_30px_60px_rgba(0,0,0,0.9)]" />
          </div>
          ...
          <div className="mb-16 max-w-4xl mx-auto relative">
            <div className="relative overflow-hidden rounded-[2rem] border-[0.5px] border-white/30 shadow-[0_30px_60px_rgba(0,0,0,0.6)]">
              <div className="relative">
                ...
                <img src="images/bloco2.webp" alt="Comparativo Flora Line" className="w-full h-auto" />
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: "url('images/fundo-secao.webp')",
          ...
          <div className="border border-white/10 rounded-[3rem] p-6 md:p-12 shadow-[0_30px_100px_rgba(0,0,0,0.8)] relative overflow-hidden" style={{ backgroundColor: '#222222' }}>
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
              <div className="w-full md:w-[45%] flex justify-center items-center relative">
                ...
                <img src="images/plano-basico.webp" alt="Pack Flora Line Mockup" className="w-full h-auto drop-shadow-[0_15px_40px_rgba(0,0,0,0.6)] animate-float-slow" />
              </div>
          ...
          {[
            ...
            >
              ...
              <div className="flex-grow flex items-center justify-center mb-4 relative min-h-[300px]">
                ...
                <img src={bonus.id === 1 ? "images/bonus1.webp" : bonus.id === 2 ? "images/bonus2.webp" : "images/bonus3.webp"} alt={bonus.title} className="w-full max-w-[340px] h-auto drop-shadow-[0_25px_45px_rgba(0,0,0,0.7)] animate-float-slow relative z-10" />
              </div>
      ...
      <Section id="ofertas" style={{ background: 'linear-gradient(135deg, #0F0302 0%, #1A0404 100%)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
          ...
          >
            ...
            <img src="images/plano-basico.webp" alt="Basic Pack" className="w-full max-w-[360px] h-auto mb-10 drop-shadow-lg" />
          ...
          >
            ...
            <img src="images/plano-profissional.webp" alt="Professional Pack" className="w-full max-w-[650px] h-auto mb-14 drop-shadow-[0_25px_50px_rgba(0,0,0,0.7)] scale-125" />
